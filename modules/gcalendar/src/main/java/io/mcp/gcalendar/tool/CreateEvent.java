...
public class CreateEvent extends BaseMcpTool {

    private final GoogleCalendarService service;

    public CreateEvent(GoogleCalendarService service) {
    ...
    public CompletableFuture<McpSchema.CallToolResult> call(McpAsyncServerExchange exchange, CallToolRequest request) {
        try {
            ...
            String summary = require(args, "summary");
            String startTime = require(args, "startTime");
            String endTime = require(args, "endTime");
